...
calls setsockopt(SO\_\-RCVTIMEO) and setsockopt(SO\_\-SNDTIMEO) to set a timeout on the following input/output operations If sec=0 \&\& usec=0 timeout is eliminated 
