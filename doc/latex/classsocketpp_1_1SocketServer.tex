...
\index{socketpp::SocketServer@{socketpp::SocketServer}!SocketServer@{SocketServer}}
\index{SocketServer@{SocketServer}!socketpp::SocketServer@{socketpp::SocketServer}}
\subsubsection[{SocketServer}]{\setlength{\rightskip}{0pt plus 5cm}socketpp::SocketServer::SocketServer (type {\em t}, \/  in\_\-addr\_\-t {\em addr}, \/  const std::string \& {\em serv}, \/  const char $\ast$ {\em prot} = {\tt NULL}, \/  unsigned int {\em maxconn} = {\tt 0})}}
...
\index{socketpp::SocketServer@{socketpp::SocketServer}!SocketServer@{SocketServer}}
\index{SocketServer@{SocketServer}!socketpp::SocketServer@{socketpp::SocketServer}}
\subsubsection[{SocketServer}]{\setlength{\rightskip}{0pt plus 5cm}socketpp::SocketServer::SocketServer (type {\em t}, \/  const std::string \& {\em addr}, \/  const std::string \& {\em serv}, \/  const char $\ast$ {\em prot} = {\tt NULL}, \/  unsigned int {\em maxconn} = {\tt 0})}}
