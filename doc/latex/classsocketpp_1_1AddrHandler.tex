...
\index{socketpp::AddrHandler@{socketpp::AddrHandler}!cleanDnsCache@{cleanDnsCache}}
\index{cleanDnsCache@{cleanDnsCache}!socketpp::AddrHandler@{socketpp::AddrHandler}}
\subsubsection[{cleanDnsCache}]{\setlength{\rightskip}{0pt plus 5cm}void socketpp::AddrHandler::cleanDnsCache ()\hspace{0.3cm}{\tt  \mbox{[}inline\mbox{]}}}}
...
\subsubsection[{getDnsCache}]{\setlength{\rightskip}{0pt plus 5cm}std::map$<$std::string,std::string$>$ socketpp::AddrHandler::getDnsCache ()\hspace{0.3cm}{\tt  \mbox{[}inline\mbox{]}}}}
...
\index{socketpp::AddrHandler@{socketpp::AddrHandler}!getServiceName@{getServiceName}}
\index{getServiceName@{getServiceName}!socketpp::AddrHandler@{socketpp::AddrHandler}}
\subsubsection[{getServiceName}]{\setlength{\rightskip}{0pt plus 5cm}std::string socketpp::AddrHandler::getServiceName ({\bf port\_\-t} {\em port}, \/  const char $\ast$ {\em prot} = {\tt NULL})\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\index{socketpp::AddrHandler@{socketpp::AddrHandler}!getServicePort@{getServicePort}}
\index{getServicePort@{getServicePort}!socketpp::AddrHandler@{socketpp::AddrHandler}}
\subsubsection[{getServicePort}]{\setlength{\rightskip}{0pt plus 5cm}{\bf port\_\-t} socketpp::AddrHandler::getServicePort (const std::string \& {\em name}, \/  const char $\ast$ {\em prot} = {\tt NULL})}}
...
conversion from IPv4 dotted decimal format to numerical one 
...
\subsubsection[{isIPv4}]{\setlength{\rightskip}{0pt plus 5cm}bool socketpp::AddrHandler::isIPv4 (const std::string \& {\em str})\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
\label{classsocketpp_1_1AddrHandler_652e24c273f7905cebf8d04b3cfef74d}


checks whether given string is in IPv4 dotted decimal format 
