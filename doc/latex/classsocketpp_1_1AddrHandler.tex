...
\subsubsection[{getservbyname}]{\setlength{\rightskip}{0pt plus 5cm}port\_\-t socketpp::AddrHandler::getservbyname (const std::string \& {\em name}, \/  const char $\ast$ {\em prot} = {\tt NULL})\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{getservbyport}]{\setlength{\rightskip}{0pt plus 5cm}std::string socketpp::AddrHandler::getservbyport (port\_\-t {\em port}, \/  const char $\ast$ {\em prot} = {\tt NULL})  throw ()\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
