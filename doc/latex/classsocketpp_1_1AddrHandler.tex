...
\index{socketpp::AddrHandler@{socketpp::AddrHandler}!getAddrByIface@{getAddrByIface}}
\index{getAddrByIface@{getAddrByIface}!socketpp::AddrHandler@{socketpp::AddrHandler}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}in\_\-addr\_\-t socketpp::AddrHandler::getAddrByIface (const std::string \& {\em name})}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}std::string socketpp::AddrHandler::gethostbyname (const std::string \& {\em name})}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}std::string socketpp::AddrHandler::gethostbyaddr (const std::string \& {\em addr})}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}port\_\-t socketpp::AddrHandler::getservbyname (const std::string \& {\em name}, \/  const char $\ast$ {\em prot} = {\tt NULL})\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}std::string socketpp::AddrHandler::getservbyport (port\_\-t {\em port}, \/  const char $\ast$ {\em prot} = {\tt NULL})  throw ()\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}bool socketpp::AddrHandler::isIPv4 (const std::string \& {\em str})  throw ()\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}in\_\-addr\_\-t socketpp::AddrHandler::inet\_\-aton (const std::string \& {\em str})\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}std::string socketpp::AddrHandler::inet\_\-ntoa (in\_\-addr\_\-t {\em addr})  throw ()\hspace{0.3cm}{\tt  \mbox{[}static\mbox{]}}}}
...
\index{socketpp::AddrHandler@{socketpp::AddrHandler}!getDnsCache@{getDnsCache}}
\index{getDnsCache@{getDnsCache}!socketpp::AddrHandler@{socketpp::AddrHandler}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}std::map$<$std::string,std::string$>$ socketpp::AddrHandler::getDnsCache ()\hspace{0.3cm}{\tt  \mbox{[}inline\mbox{]}}}}
